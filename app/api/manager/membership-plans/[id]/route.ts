...
export async function GET(
  ...
  try {
    ...
    console.error("GET MANAGER MEMBERSHIP PLAN DETAIL ERROR:", error);
...
export async function PUT(
  ...
  try {
    ...
    console.error("UPDATE MANAGER MEMBERSHIP PLAN ERROR:", error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE MANAGER MEMBERSHIP PLAN ERROR:", error);
